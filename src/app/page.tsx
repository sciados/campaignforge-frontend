...
export default function ComingSoonPage() {
  ...
  // UPDATED: Add user navigation hook
  const {
    dashboardRoute,
    userType,
  ...
  return (
    <div className="min-h-screen bg-white font-inter">
      {/* UPDATED: Navigation with user-type aware routing */}
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            {/* UPDATED: Add dashboard link if user is authenticated */}
            {userType && !navLoading && (
      ...
      <main className="relative">
        <div className="max-w-4xl mx-auto px-6 pt-32 pb-32 text-center">
          {/* UPDATED: Status Badge with user context */}
          <div className="mb-8">
            <span className="inline-block bg-gray-100 text-gray-600 px-4 py-2 rounded-full text-sm font-medium">
              {userType
                ? `Welcome back, ${userType.replace("_", " ")} user!`
                : "Coming Soon"}
            </span>
          </div>

          {/* UPDATED: Conditional heading based on user status */}
          ...
          <p className="text-xl text-gray-600 mb-16 max-w-2xl mx-auto leading-relaxed">
            {userType
              ? "Access your personalized dashboard and start creating intelligent campaigns with AI-powered insights."
              : "RodgersDigital is crafting the future of intelligent content transformation. Get ready for AI-powered campaign creation like never before."}
          </p>

          {/* UPDATED: Show dashboard CTA for authenticated users */}
          {userType ? (
            <div className="mb-16">
              <Link
                href={dashboardRoute}
                className="inline-block bg-black text-white px-12 py-6 rounded-xl font-semibold text-lg hover:bg-gray-900 transition-all shadow-lg"
              >
            ...
            <>
              {/* Countdown Timer - only show for non-authenticated users */}
              <div className="mb-16">
              ...
              {/* Waitlist - only show for non-authenticated users */}
              <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Revolutionary content analysis and campaign generation powered
                by advanced AI.
              </p>
            </div>
            ...
            <div className="text-center p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Generate complete marketing campaigns in minutes, not hours or
                days.
              </p>
            </div>
            ...
            <div className="text-center p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                From social media to landing pages - everything you need in one
                platform.
              </p>
            </div>
          </div>
        ...
        {/* Rest of sections remain unchanged - Progress Section, Contact Section, Footer */}
        {/* ... */}
      </main>
    </div>
  );
