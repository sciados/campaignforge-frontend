// src/app/dashboard/content-creator/page.tsx
"use client";
...
export default function ContentCreatorDashboardPage() {
  ...
  const fetchDashboardConfig = useCallback(async () => {
    try {
      setError(null);
      console.log("Loading content creator dashboard config...");

      // Create a content creator specific config (same as product creator)
      const configData = {
        user_profile: {
        ...
        dashboard_title: "Content Creator Dashboard",
        main_cta: "Submit URLs",
        theme_color: "blue"
      };

      console.log("Content creator dashboard config loaded:", configData);
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">
            Loading your content creator dashboard...
          </p>
        </div>
      </div>
    );
