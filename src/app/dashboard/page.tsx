          ...
          <div className="max-w-6xl space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 border border-purple-100">
                ...
                <h3 className="text-xl font-semibold text-black mb-2">ClickBank Marketplace</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Discover high-converting products and create campaigns instantly
                </p>
                <button 
                  onClick={() => router.push('/marketplace')}
                  className="text-purple-600 font-medium text-sm flex items-center space-x-1 hover:translate-x-1 transition-transform"
                >
              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <h3 className="text-xl font-semibold text-black mb-2">Video Campaign</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Transform videos into complete marketing campaigns
                </p>
                <button 
                  onClick={() => router.push('/campaigns')}
              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <h3 className="text-xl font-semibold text-black mb-2">AI Visual Content</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Generate stunning visuals with AI technology
                </p>
                <button 
                  onClick={() => router.push('/campaigns')}
                  className="text-black font-medium text-sm flex items-center space-x-1 hover:translate-x-1 transition-transform"
